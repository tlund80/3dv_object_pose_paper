...
either has been or will be submitted during the 3DV 2015 review period to
...
3DV papers should be no longer than 8 pages, excluding references, and no longer than 
9 pages in total length. Overlength papers will simply not be reviewed.  This includes papers
